...
async function getList(order) {
	const {
		data: { total, records },
	} = await api.get("/web/a3ssMatsJece/page", { ...pagination, ...search.value, dataAccessId,file })
...
const down = async () => {
	await api.down("/web/a3ssMatsJece/exportExcel", { ...pagination,...search.value, dataAccessId, file })
}
...
<template>
	<div class="sub_content">
		<Search :search="search" :fn="getList" :down="down" title="a3SS"/>
		<div class="my-table">
			<el-table :data="tableData" border stripe size="default" @sort-change="sortChange">
				...
				<el-table-column sortable="custom" show-overflow-tooltip prop="longExonStart0Base" label="longExonStart_0base" min-width="200" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="longExonEnd" label="longExonEnd" min-width="140" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="shortEs" label="shortES" min-width="120" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="shortEe" label="shortEE" min-width="120" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="flankingEs" label="flankingES" min-width="140" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="flankingEe" label="flankingEE" min-width="120" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="id" label="ID" min-width="120" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="ijcSample1" label="IJC_SAMPLE_1" min-width="160" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="sjcSample1" label="SJC_SAMPLE_1" min-width="160" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="ijcSample2" label="IJC_SAMPLE_2" min-width="160" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="sjcSample2" label="SJC_SAMPLE_2" min-width="160" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="incFormLen" label="IncFormLen" min-width="130" />
