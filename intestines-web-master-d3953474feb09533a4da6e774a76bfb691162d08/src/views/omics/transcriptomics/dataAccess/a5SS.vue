...
async function getList(order) {
	const {
		data: { total, records },
	} = await api.get("/web/a5ssMatsJcec/page", { ...pagination, ...search.value, dataAccessId, file })
...
const down = async () => {
	await api.down("/web/a5ssMatsJcec/exportExcel", { ...pagination, ...search.value, dataAccessId, file })
}
...
<template>
	<div class="sub_content">
		<Search :search="search" :fn="getList" :down="down" title="a5SS"/>
		<div class="my-table">
