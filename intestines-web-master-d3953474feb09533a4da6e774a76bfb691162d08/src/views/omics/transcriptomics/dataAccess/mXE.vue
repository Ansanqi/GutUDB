...
async function getList(order) {
	const {
		data: { total, records },
	} = await api.get("/web/mxeMatsJcec/page", { ...pagination, ...search.value, dataAccessId, file })
...
const down = async () => {
	await api.down("/web/mxeMatsJcec/exportExcel", { ...pagination, ...search.value, dataAccessId, file })
}
...
<template>
	<div class="sub_content">
		<Search :search="search" :fn="getList" :down="down" title="mXE"/>
		<div class="my-table">
			<el-table :data="tableData" border stripe size="default" @sort-change="sortChange">
				...
				<el-table-column sortable="custom" show-overflow-tooltip prop="firstExonStart0Base" label="1stExonStart_0base" min-width="200" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="firstExonEnd" label="1stExonEnd" min-width="140" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="secondExonStart0Base" label="2ndExonStart_0base" min-width="190" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="secondExonEnd" label="2ndExonEnd" min-width="140" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="upstreamEs" label="upstreamES" min-width="130" />
				<el-table-column sortable="custom" show-overflow-tooltip prop="upstreamEe" label="upstreamEE" min-width="130" />
				...
				<el-table-column sortable="custom" show-overflow-tooltip prop="id" label="ID" min-width="150" />
