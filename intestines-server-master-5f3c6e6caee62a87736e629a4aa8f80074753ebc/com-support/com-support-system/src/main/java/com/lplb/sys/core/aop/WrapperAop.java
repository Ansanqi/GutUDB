...
import com.lplb.core.annotion.Wrapper;
import com.lplb.core.consts.AopSortConstant;
import com.lplb.core.exception.ServiceException;
import com.lplb.core.exception.enums.WrapperExceptionEnum;
import com.lplb.core.pojo.base.wrapper.BaseWrapper;
...
public class WrapperAop {
     ...
     * @date 2020/7/24 17:42
     */
    @Pointcut("@annotation(com.lplb.core.annotion.Wrapper)")
    ...
    private Object processWrapping(ProceedingJoinPoint proceedingJoinPoint, Object originResult) throws IllegalAccessException, InstantiationException {
        ...
        // 如果是PageResult类型
            ...
            ArrayList<Map<String, Object>> maps = new ArrayList<>();
            for (Object wrappedItem : pageResult.getList()) {
                maps.add(this.wrapPureObject(wrappedItem, baseWrapperClasses));
            }
