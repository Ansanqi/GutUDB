 ...
 */
package com.lplb.sys.core.listener;
...
public class ConstantsInitListener implements ApplicationListener<ApplicationContextInitializedEvent>, Ordered {
    ...
    public void onApplicationEvent(ApplicationContextInitializedEvent applicationContextInitializedEvent) {
        ...
        String dataSourceUsername = environment.getProperty("spring.datasource.username").replace("ENC(","").replace(")","");
        String dataSourcePassword = environment.getProperty("spring.datasource.password").replace("ENC(","").replace(")","");
        // 如果有为空的配置，终止执行
