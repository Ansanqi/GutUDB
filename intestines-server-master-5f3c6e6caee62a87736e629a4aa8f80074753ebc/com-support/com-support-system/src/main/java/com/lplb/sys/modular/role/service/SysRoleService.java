 ...
 */
package com.lplb.sys.modular.role.service;
...
public interface SysRoleService extends IService<SysRole> {
    ...
    List<SysRole> listRoles(SysRoleParam sysRoleParam);
    ...
    /**
     * 根据角色编码获取角色
     * @param projectLeaderCode
     * @return
     */
    SysRole getRoleByRoleCode(String projectLeaderCode);
