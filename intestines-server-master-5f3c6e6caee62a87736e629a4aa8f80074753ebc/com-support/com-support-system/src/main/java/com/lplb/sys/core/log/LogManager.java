...
import com.lplb.sys.core.log.factory.LogFactory;
import com.lplb.sys.core.log.factory.LogTaskFactory;
...
public class LogManager {
     ...
     * @date 2020/3/18 20:01
     */
    public void executeExceptionLog(BusinessLog businessLog, final String account, JoinPoint joinPoint, Exception exception,String bsl) {
        SysOpLog sysOpLog = this.genBaseSysOpLog();
