...
import com.lplb.sys.core.cache.MappingCache;
...
//        return new UserCache(timedCache);
        RedisTemplate<String,SysLoginUser> redisCache = new RedisTemplate<>();
        return new UserCache(redisCache);
    }
...
//                CacheUtil.newTimedCache(60 * 1000);
//
//        //定时清理缓存，间隔1秒
//        timedCache.schedulePrune(1000);

//        return new CaptchaCache(timedCache);
        RedisTemplate<String,Map<String,Object>> redisCache = new RedisTemplate<>();
        return new CaptchaCache(redisCache);
    }
...
//        TimedCache<String, Map<String, Object>> timedCache =
//                CacheUtil.newTimedCache(2 * 60 * 1000L);
//
//        // 定时清理缓存，间隔1秒
//        timedCache.schedulePrune(1000);
...
//        return new MappingCache(timedCache);
        RedisTemplate<String, Map<String, Object>> redisCache = new RedisTemplate<>();
        return new MappingCache(redisCache);
    }
