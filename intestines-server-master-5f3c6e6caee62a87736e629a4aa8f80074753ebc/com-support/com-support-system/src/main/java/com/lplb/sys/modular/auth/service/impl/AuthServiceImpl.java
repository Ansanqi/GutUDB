 ...
 */
package com.lplb.sys.modular.auth.service.impl;
...
import com.lplb.core.dbs.CurrentDataSourceContext;
import com.lplb.core.enums.CommonStatusEnum;
import com.lplb.core.exception.AuthException;
import com.lplb.core.exception.ServiceException;
import com.lplb.core.exception.enums.AuthExceptionEnum;
import com.lplb.core.exception.enums.ServerExceptionEnum;
import com.lplb.core.pojo.login.SysLoginUser;
import com.lplb.core.tenant.context.TenantCodeHolder;
import com.lplb.core.tenant.context.TenantDbNameHolder;
import com.lplb.core.tenant.entity.TenantInfo;
import com.lplb.core.tenant.exception.TenantException;
import com.lplb.core.tenant.exception.enums.TenantExceptionEnum;
import com.lplb.core.tenant.service.TenantInfoService;
import com.lplb.core.util.HttpServletUtil;
import com.lplb.core.util.IpAddressUtil;
import com.lplb.sys.core.cache.UserCache;
import com.lplb.sys.core.enums.LogSuccessStatusEnum;
import com.lplb.sys.core.jwt.JwtPayLoad;
import com.lplb.sys.core.jwt.JwtTokenUtil;
import com.lplb.sys.core.log.LogManager;
import com.lplb.sys.modular.auth.factory.LoginUserFactory;
...
public class AuthServiceImpl implements AuthService, UserDetailsService {
     ...
     */
    private Map<String,Object> doLogin(SysUser sysUser) {
        ...
        userInfo.put("avatar", CommonConstant.DEFAULT_AVATAR);
        userInfo.put("userName",sysUser.getName());
        return userInfo;
    }
    ...
    private void cacheLoginUser(JwtPayLoad jwtPayLoad, SysLoginUser sysLoginUser) {
        ...
        userCache.put(redisLoginUserKey, sysLoginUser,ConstantContextHolder.getSessionTokenExpireSec());
    }
}
