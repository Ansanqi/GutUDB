 ...
 */
package com.lplb.sys.modular.menu.controller;
...
//    @BusinessLog(title = "系统菜单_切换", opType = LogAnnotionOpTypeEnum.TREE)
    ...
    public Object getMenus(){
        List<Map<String,Object>> result = sysMenuService.getLoginUserMenu(LoginContextHolder.me().getSysLoginUserId());
        return SuccessResponseData.success(result);
    }

    @GetMapping("/system/menu")
    public Object getMenuPage(){
        return SuccessResponseData.success(sysMenuService.getMenuPage());
    }

    @PostMapping("/system/menu")
    public Object saveMenu(@RequestBody SysMenuParam sysMenuParam){
        sysMenuService.saveMenu(sysMenuParam);
        return SuccessResponseData.success();
    }
    @PutMapping("/system/menu")
    public Object updateMenu(@RequestBody SysMenuParam sysMenuParam){
        sysMenuService.saveMenu(sysMenuParam);
        return SuccessResponseData.success();
    }
}
