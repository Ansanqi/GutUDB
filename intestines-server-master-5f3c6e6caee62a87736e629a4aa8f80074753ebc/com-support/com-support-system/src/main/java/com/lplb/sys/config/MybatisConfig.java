...
import com.lplb.sys.core.mybatis.dbid.GunsDatabaseIdProvider;
import com.lplb.sys.core.mybatis.fieldfill.CustomMetaObjectHandler;
import com.lplb.sys.core.mybatis.sqlfilter.DemoProfileSqlInterceptor;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.lplb.**.mapper"})
