 ...
 */
package com.lplb.sys.modular.consts.service.impl;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.ObjectUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.lplb.core.context.constant.ConstantContext;
import com.lplb.core.enums.CommonStatusEnum;
import com.lplb.core.enums.YesOrNotEnum;
...
import com.lplb.sys.modular.consts.enums.SysConfigExceptionEnum;
import com.lplb.sys.modular.consts.mapper.SysConfigMapper;
import com.lplb.sys.modular.consts.param.SysConfigParam;
import com.lplb.sys.modular.consts.service.SysConfigService;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements SysConfigService {
    ...
    public PageResult<SysConfig> page(SysConfigParam sysConfigParam) {
        ...
        //查询显示的
        queryWrapper.eq(SysConfig::getIsShow,"1");
        //按类型升序排列，同类型的排在一起
    ...
    @Override
    public Object getLoginTimeSetting() {
        LambdaQueryWrapper<SysConfig> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(SysConfig::getCode,"GUNS_LOGIN_TIME_CHECK");
        queryWrapper.last("limit 1");
        SysConfig config = this.getOne(queryWrapper);
        return SuccessResponseData.success(config.getValue());
    }
}
