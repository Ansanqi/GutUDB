 ...
 */
package com.lplb.sys.modular.dict.service;
...
public interface SysDictDataService extends IService<SysDictData> {
     ...
     * @return
     */
    List<SysDictData> getDictDataByCode(SysDictTypeParam sysDictTypeParam);
     ...
     * @return
     */
    List<String> getDictDataNameByCode(String typeCode);
    /**
     * 添加系统字典值
     *
     ...
     * @return
     */
    String getDictValueByType(String typeCode,String dataCode);
     ...
     * @return
     */
    Integer getDictSortByType(String typeCode,String dataCode);

    /**
     * 检查密级
     * @param uSecretLevel
     * @param businessSecretLevel
     * @return
     */
    boolean checkSecretLevel(String uSecretLevel,String businessSecretLevel);

    /**
     * 根据字典值名称查询值
     * @return
     */
    String getDictTypeCodeByName(String dictType,String dictDataName);
     ...
     * @return
     */
    List<Map<String, Object>> getDictDataListByDictType(String dictType);
}
