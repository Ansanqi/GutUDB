...
import com.lplb.sys.modular.user.mapper.SysUserRoleMapper;
...
public class SysUserRoleServiceImpl extends ServiceImpl<SysUserRoleMapper, SysUserRole> implements SysUserRoleService {
    ...
    public void grantRole(SysUserParam sysUserParam) {
        ...
        //授权角色
        sysUserParam.getRoleIds().forEach(roleId -> {
    ...
    @Override
    public List<String> getUserRoleName(Long userId) {
        return this.getBaseMapper().getUserRoleName(userId);
    }

    @Override
    public List<String> getUserRoleCode(Long userId) {
        return this.getBaseMapper().getUserRoleCode(userId);
    }
    ...
    public List<Long> getUserIdByRole(Long roleId) {
        return this.getBaseMapper().getUserIdByRole(roleId);
    }

    @Override
    public List<SysRole> getUserRole(Long id) {
        return this.getBaseMapper().getUserRole(id);
    }
}
