...
import com.lplb.sys.modular.dict.enums.SysDictTypeExceptionEnum;
import com.lplb.sys.modular.dict.mapper.SysDictTypeMapper;
import com.lplb.sys.modular.dict.param.SysDictTypeParam;
import com.lplb.sys.modular.dict.result.SysDictTreeNode;
import com.lplb.sys.modular.dict.service.SysDictDataService;
import com.lplb.sys.modular.dict.service.SysDictTypeService;
...
public class SysDictTypeServiceImpl extends ServiceImpl<SysDictTypeMapper, SysDictType> implements SysDictTypeService {
    ...
    public PageResult<SysDictType> page(SysDictTypeParam sysDictTypeParam) {
        ...
        queryWrapper.eq(SysDictType::getLv, 1);
        //查询未删除的
