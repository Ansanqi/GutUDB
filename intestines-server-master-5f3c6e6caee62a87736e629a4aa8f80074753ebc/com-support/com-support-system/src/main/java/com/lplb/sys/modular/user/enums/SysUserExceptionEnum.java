 ...
 */
package com.lplb.sys.modular.user.enums;
...
import com.lplb.sys.core.consts.SysExpEnumConstant;
...
public enum SysUserExceptionEnum implements AbstractBaseExceptionEnum {
     ...
     * 账号已存在
     */
    USER_ACCOUNT_REPEAT(2, "账号已存在"),

    /**
     * 原密码错误
     */
    USER_PWD_ERROR(3, "原密码错误"),

    /**
     * 新密码与原密码相同
     */
    USER_PWD_REPEAT(4, "新密码与原密码相同"),
