...
public class PermissionAop {
     ...
     */
    @Pointcut("@annotation(com.lplb.core.annotion.Permission)")
    ...
    private void executeNoPermissionExceptionLog(JoinPoint joinPoint, Exception exception) {
        ...
        LogManager.me().executeExceptionLog(
                businessLog, LoginContextHolder.me().getSysLoginUserAccount(), joinPoint, exception,null);
    }
