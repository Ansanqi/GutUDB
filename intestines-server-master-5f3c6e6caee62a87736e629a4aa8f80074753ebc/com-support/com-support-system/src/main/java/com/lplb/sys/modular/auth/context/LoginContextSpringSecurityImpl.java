 ...
 */
package com.lplb.sys.modular.auth.context;
...
import com.lplb.sys.modular.role.constants.RoleConstants;
...
public class LoginContextSpringSecurityImpl implements LoginContext {
    ...
    public boolean hasPermission(String requestUri) {
        String removePrefix = StrUtil.removePrefix(requestUri, servletContextPath+SymbolConstant.LEFT_DIVIDE);
    ...
    public boolean isOrgAdmin() {
        return this.hasRole(RoleConstants.ORG_ADMIN_ROLE_CODE);
    }
