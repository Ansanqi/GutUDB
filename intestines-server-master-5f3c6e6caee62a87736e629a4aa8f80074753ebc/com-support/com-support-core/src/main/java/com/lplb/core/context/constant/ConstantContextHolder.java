 ...
 */
package com.lplb.core.context.constant;
...
import com.lplb.core.pojo.email.EmailConfigs;
import com.lplb.core.pojo.sms.AliyunSmsConfigs;
import com.lplb.core.pojo.sms.TencentSmsConfigs;
...
public class ConstantContextHolder {
    ...
    public static List<String> getUnXssFilterUrl() {
        String gunsUnXssFilterUrl = getSysConfigWithDefault("GUNS_UN_XSS_FILTER_URL", String.class, "");
        if (ObjectUtil.isEmpty(gunsUnXssFilterUrl)) {
            return CollUtil.newArrayList();
        } else {
            return CollUtil.toList(gunsUnXssFilterUrl.split(SymbolConstant.COMMA));
        }
    }
    ...
    public static String getDefaultPassWord() {
        return getSysConfigWithDefault("GUNS_DEFAULT_PASSWORD", String.class,"");
    }
    ...
    public static String getOSSDomain(){
        return getSysConfigWithDefault("OSS_DOMAIN", String.class, "https://adgu-hd.oss-cn-beijing.aliyuncs.com");
    }

    public static String getSystemOrgIndependent(){
        return getSysConfigWithDefault("SYSTEM_ORG_INDEPENDENT", String.class, "false");
    }
     ...
     * @return
     */
    public static String getSystemDeploymentMode(){
        return getSysConfigWithDefault("SYSTEM_DEPLOYMENT_MODE",String.class,"yuan");
    }
    /**
