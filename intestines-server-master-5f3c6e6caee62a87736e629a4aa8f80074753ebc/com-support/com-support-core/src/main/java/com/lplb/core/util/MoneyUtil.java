...
public class MoneyUtil {
    ...
    public static String formatMoney(String value){
        ...
        return addComma(new DecimalFormat("##0.00").format(new BigDecimal(value)));
    }

    public static String formatMoneyTwo(String value){
        if(value == null || "".equals(value) ){
            value = "0.00";
        }
    ...
    public static void main(String[] args) {
        System.out.println(addComma(formatMoney("5.8")));
    }
}