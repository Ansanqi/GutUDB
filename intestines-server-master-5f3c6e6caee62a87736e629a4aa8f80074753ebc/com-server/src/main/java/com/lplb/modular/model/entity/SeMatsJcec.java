...
@TableName("in_se_mats_jcec")
public class SeMatsJcec extends BaseEntity {
     ...
     */
    @ApiModelProperty(value = "exonStart_0base（显子起始0碱基）")
    @TableField(value = "exon_start_0_base")
    private Long exonStart0Base;

    /**
     * exonEnd（显子结束）
     */
    @ApiModelProperty(value = "exonEnd（显子结束）")
    @TableField(value = "exon_end")
